...
var VisionBase = class {
  ...
  async init(params) {
    ...
    this.document = new Document({
      pageContent: readFileSync((_a = this.params.documentPath) != null ? _a : "../document/main.md", "utf-8"),
      metadata: {
...
var VisionZhipuAI = class extends VisionBase {
  ...
  async generate(userInput, width, height) {
    ...
    const response = await ((_b = this.model) == null ? void 0 : _b.invoke([prompts, new SystemMessage(knowledges), new HumanMessage(userInput)]));
